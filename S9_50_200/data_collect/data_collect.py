...
'''
# 50 nm
scan_id = range(203819, 203999+1, 5)

# 200 nm
scan_id = range(203821, 204001+1, 5)
...
'''
scanid_hr = list(range(203819, 203999+1, 5))
scanid_lr = list(range(203821, 204001+1, 5))
...
hr_train_scanid = scanid[:-5, 0]
lr_train_scanid = scanid[:-5, 1]

hr_eval_scanid = scanid[-5:, 0]
lr_eval_scanid = scanid[-5:, 1]
...
def savetiff2(path2save, scanid_list):
    ...
    for i, scanid in enumerate(scanid_list):
        # print(scanid)
        Zn = io.imread(rf'D:/Research_data/RCAN_HXN/Natural_images_norm_scale2_8_finetune/xrf_S9/xrf/output_tiff_scan2D_{scanid}/detsum_Mn_K_norm.tiff')
        Mn = io.imread(rf'D:/Research_data/RCAN_HXN/Natural_images_norm_scale2_8_finetune/xrf_S9/xrf/output_tiff_scan2D_{scanid}/detsum_Zn_K_norm.tiff')
...
hr_train_path = r'D:\Research_data\RCAN_ZSSR\S9_50_200\data_collect/img_train_hr'
lr_train_path = r'D:\Research_data\RCAN_ZSSR\S9_50_200\data_collect/img_train_lr'

hr_eval_path = r'D:\Research_data\RCAN_ZSSR\S9_50_200\data_collect/img_eval_hr'
lr_eval_path = r'D:\Research_data\RCAN_ZSSR\S9_50_200\data_collect/img_eval_lr'
