...
if __name__ == '__main__':
    ...
    parser.add_argument('--train-file', type=str, default=r'D:/Research_data/RCAN_ZSSR/S9_50_200/training/S9_crop_norm_training.h5')
    parser.add_argument('--eval-file', type=str, default=r'D:/Research_data/RCAN_ZSSR/S9_50_200/training/S9_crop_norm_eval.h5')
    parser.add_argument('--outputs-dir', type=str, default=r'./S9_50_200_finetune_submean')
